...
//#region isomorphic-lib-v20 component

//#region @browser
@Component({
  selector: 'app-isomorphic-lib-v20',
  standalone: false,
  template: `hello from isomorphic-lib-v20<br />
...
export class IsomorphicLibV20Component {
  angularVersion =
    VERSION.full +
...
//#region  isomorphic-lib-v20 api service
...
//#region  isomorphic-lib-v20 module
...
@NgModule({
  ...
  exports: [IsomorphicLibV20Component],
  imports: [
    CommonModule,
  ...
  declarations: [IsomorphicLibV20Component],
})
export class IsomorphicLibV20Module {}
//#endregion

//#endregion

//#region  isomorphic-lib-v20 entity
...
//#region  isomorphic-lib-v20 controller
...
//#region  isomorphic-lib-v20 migration
...
//#region  isomorphic-lib-v20 context
