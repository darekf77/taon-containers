...
//#region taon-session component
//#region @browser
@Component({
  selector: 'app-taon-session',
  standalone: false,
  template: `hello from taon-session<br />
...
//#region  taon-session api service
//#region @browser
@Injectable({
  providedIn: 'root',
})
...
@NgModule({
  ...
  declarations: [TaonSessionComponent],
})
export class TaonSessionModule {}
//#endregion
//#endregion

//#region  taon-session entity
...
//#region  taon-session controller
